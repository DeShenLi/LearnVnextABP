...
namespace VnextProject.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update VnextProjectDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update VnextProjectEfCoreEntityExtensionMappings to extend the IdentityUser entity
