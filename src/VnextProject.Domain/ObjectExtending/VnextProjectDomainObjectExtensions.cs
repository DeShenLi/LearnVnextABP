...
namespace VnextProject.ObjectExtending
{
    public static class VnextProjectDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the VnextProjectEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
